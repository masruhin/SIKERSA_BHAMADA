...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="">
  ...
  <nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center" data-nav="brand-center">
    <div class="navbar-header d-xl-block d-none"></div>
      ...
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="../../vendor/html/ltr/horizontal-menu-template/index.html">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span class="badge badge-pill badge-light-primary mr-1">Fakultas Ekonomi Bisnis</span>
                      </td>
                      <td>
