      ...
      if ($adasub->num_rows > 0) {
        echo '<li class="active" data-menu="">
                <a class="dropdown-item d-flex align-items-center" href="maps-leaflet.html" data-toggle="dropdown" data-i18n="Leaflet Maps">
                  <i data-feather="home">Dashboards</i>
                  <span data-i18n="Leaflet Maps">Dashboards</span>
                </a>
              </li>
                <li class="active" data-menu="">
                  <a class="dropdown-item d-flex align-items-center" href="#" data-toggle="dropdown" data-i18n="Leaflet Maps">
        ...
        echo '<a class="dropdown-item" href="' . $r->link . '">
                <i data-feather="' . $r->icon . '"></i>
              ' . $r->nama_modulutama . '</a>';
      }
    }
