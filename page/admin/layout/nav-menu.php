      ...
      <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
          ...
          <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            <li data-menu="">
              <a class="dropdown-item d-flex align-items-center" href="page/member/member-dashboard.php">
                <i data-feather="home"></i><span data-i18n="Documentation">Home</span>
              </a>
            </li>
            <li data-menu="">
              <a class="dropdown-item d-flex align-items-center" href="page/member/profile-bhamada.php">
            ...
            <li data-menu="">
              <a class="dropdown-item d-flex align-items-center" href="page/member/member-kontak-kami.php">
                <i data-feather="phone-call"></i>
                <span data-i18n="Documentation">Kontak Kami</span>
              </a>
            </li>
            <li data-menu="">
              <a class="dropdown-item d-flex align-items-center" href="page/member/member-statistik.php">
                <i data-feather="bar-chart-2"></i>
